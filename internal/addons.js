...
module.exports.install = async addon => {
    ...
    if (!existsSync(`${Paths.getSteamApplications()}/common/Left 4 Dead 2/left4dead2/addons/${addon.publishedfileid}`)) {
    ...
    if (!existsSync(`${Paths.getSteamApplications()}/common/Left 4 Dead 2/left4dead2/addons/${addon.publishedfileid}/addoninfo.txt`)) {
        ...
        writeFileSync(`${Paths.getSteamApplications()}/common/Left 4 Dead 2/left4dead2/addons/${addon.publishedfileid}/addoninfo.txt`,
`"AddonInfo"
{
